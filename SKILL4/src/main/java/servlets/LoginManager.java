...
//		doGet(request, response);
		Managers l = new Managers();
		try {
			System.out.println(request.getParameter("uname")+request.getParameter("psw"));
		boolean loginstatus = l.authmanager(request.getParameter("uname"), request.getParameter("psw"));
		if(loginstatus) {
			...
			out.write("<!doctype html>\r\n"
					...
					+ "        <a class=\"nav-link\" href=\"addmovies\">Add Movies <span class=\"sr-only\"></span></a>\r\n"
					+ "      </li>"
