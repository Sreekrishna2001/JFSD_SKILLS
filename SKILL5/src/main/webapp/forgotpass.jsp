...
<body>
 <div>
  ...
  <div class="collapse navbar-collapse ml-auto" id="navbarNavAltMarkup">
    ...
    <div>
        <form class="loginform" action="changepass.jsp" method="post">
            <h3 class="heading">Reset Password</h3>
            <div class="main">
            <div class="form-group">
                    <input type="tel" name="mobile" placeholder="mobileno" class="form-control" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="password" name="newpassword" placeholder="password" class="form-control" required>
                </div>
