...
<body>
    ...
    <div>  <nav class="navbar navbar-expand-lg navbar-dark bg-dark color-white">
  ...
  <div class="collapse navbar-collapse ml-auto" id="navbarNavAltMarkup">
    <div class="navbar-nav ml-auto">
      <a class="nav-item nav-link active" href="#">Cart <span class="sr-only">(current)</span></a>
    ...
    <div>
        <form class="signupform" action="customerReg" method="post">
            <div class="userlogo">
                <i class="fa fa-user-circle" style="font-size: 60px;" aria-hidden="true"></i>
            </div>
            <h3 class="heading">Customer Registration</h3>
            <div class="main">
			...
			<div style="margin-bottom: 20px;">
                <p>Already have an account: <a href="Login.jsp" style="color: blue;">Login</a></p>
            </div>
        </form>
    </div>
